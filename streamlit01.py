...
print("Inorder traversal of BST:", bst.inorder_traversal())'''
    ...
    with col1:
        ...
        # Configure ACE editor with hover tooltips and autocomplete
        SNIPPETS = {
            'print': {'name': 'print', 'description': 'Outputs text or values to the console', 'docstring': 'print(*values) -> None\n\nPrints the values to the console.'},
            'def': {'name': 'def', 'description': 'Defines a new function', 'docstring': 'def function_name(parameters):\n    """Function docstring"""\n    function_body'},
            'for': {'name': 'for', 'description': 'Creates a loop to iterate over a sequence', 'docstring': 'for item in sequence:\n    # Loop body'},
            'if': {'name': 'if', 'description': 'Creates a conditional statement', 'docstring': 'if condition:\n    # Code to execute if condition is True'},
            'while': {'name': 'while', 'description': 'Creates a loop that runs while a condition is True', 'docstring': 'while condition:\n    # Loop body'},
            'list': {'name': 'list', 'description': 'Creates a mutable sequence of elements', 'docstring': 'list() -> empty list\nlist(iterable) -> list from iterable'},
            'dict': {'name': 'dict', 'description': 'Creates a dictionary (key-value pairs)', 'docstring': 'dict() -> empty dictionary\ndict(mapping) -> dictionary from mapping'},
            'range': {'name': 'range', 'description': 'Creates a sequence of numbers', 'docstring': 'range(stop) -> range object\nrange(start, stop[, step]) -> range object'},
        }
